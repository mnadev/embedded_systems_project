...
HD_PWD='/home/user/my_projects/project/project/project.runs/design_1_PmodBLE_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PmodBLE_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PmodBLE_0_0.tcl
